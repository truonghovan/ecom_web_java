...
<%@ page language="java" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8"%>
<c:url var="APIurl" value="/api-admin-brand"/>
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div>
                        <button class="btn btn-danger square-btn-adjust" style="margin-bottom: 5px"><a href='<c:url value="/admin-brand-list?type=add"/>' style="color: white">Thêm thương hiệu</a></button>
                    </div>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <button style="width: 70px;">
                                                    <a href="<c:url value="/admin-brand-list?type=edit&id=${brand.id }"/>"
                                                       class="center">Xem/Sửa</a>
                                                </button>
                                                |
                                                <button id="btnDelete" type ="button" onclick = "deleteProduct(${brand.id})"
                                                        class="center">Xóa
                                                </button>
                                            </td>
                                        </tr>
